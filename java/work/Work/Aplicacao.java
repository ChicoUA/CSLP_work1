...
public class Aplicacao {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		String[] Lists= {"L1", "L2", "L3","L4","L5","L6","L7","L8","L9","L10"};//Lista 5 serve de controlo(� igual � lista 1 com diferen�as) e lista 10 � recolhida dos dados do bloomfilter. 
		int count=0;
		int k=50;
		long sum=0;
		...
		for(String i : Lists) {
			...
			while(sc.hasNextLine()) {
				count++;
				counter.adicionar();//Incremento do Contador Estoc�stico
		...
		System.out.println("Valor do Contador Estoc�stico (n�mero de livros): "+counter.getContador());
		System.out.println("Unique Books: "+NomesDeLivros.size());
		System.out.println("Valor do Contador Estoc�stico (livros �nicos: "+counter2.getContador());
		System.out.println("");
